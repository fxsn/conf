...
alias lt="ls -lhAF --color=auto --sort=time"
...
# Some useful nmap aliases for scan modes (source: https://github.com/robbyrussell/oh-my-zsh/blob/master/plugins/nmap/nmap.plugin.zsh)
